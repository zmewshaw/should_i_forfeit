...
# create and draw lines of best fit
            ...
            count += 1
            print('Simulation {count}:'.format(count=count))
            print('LP forfeit: '+str(maxForfeit))
            print('LP hostage: '+str(maxHostage))
        print('{totalHours} hours were simulated to determine that you should FF unless your game is winnable AT LEAST {winnablePercent}% of the time'.format(totalHours=count*100,winnablePercent=winnablePercent-1))
leagueStats.main()